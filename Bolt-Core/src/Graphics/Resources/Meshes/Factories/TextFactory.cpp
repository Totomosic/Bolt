...
namespace Bolt
{
	...
	TextFactory::TextFactory(const std::string& text, const ResourcePtr<Font>& font, const Bolt::Color& color, AlignH horizontalAlignment, AlignV verticalAlignment) : VertexFactory(),
