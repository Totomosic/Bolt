...
namespace Bolt
{
	...
	Window::Window(AppContext* context, const WindowCreateInfo& info)
		: m_EventBus(), m_Events{
			m_EventBus.GetEmitter<WindowResizeEvent>(),
			m_EventBus.GetEmitter<WindowMovedEvent>(),
			m_EventBus.GetEmitter<WindowFocusedEvent>(),
			m_EventBus.GetEmitter<WindowClosedEvent>(),
