...
namespace Bolt
{
	...
	public:
		...
		static void Text(const blt::string& text, const Font* font, float x, float y, float z, const Color& color = Color::White, TextAlignmentH horizontalAlign = TextAlignmentH::Center, id_t layerId = 0);
